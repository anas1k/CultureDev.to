    ...
    $(document).ready(function() {
        ...
        $('.dropify').dropify({
            tpl: {
                ...
                preview: '<div id="PreviewFileField" class="dropify-preview"><span class="dropify-render"><img style="max-height: 100% !important;"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
            },
            messages: {

                                    ...
                                    <tbody>
                                        <?php foreach ($AllCategories as $Category) { ?>
                                            <tr id="Category<?= $Category['id_category']; ?>">
                                                ...
                                                <td id="CategoryName<?= $Category['id_category']; ?>"><?= $Category['name']; ?></td>
                                                <td>
                                                    <a href="#" onclick="GetCategory('<?= $Category['id_category']; ?>')" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="#" onclick="deleteCategory('<?= $Category['id_category']; ?>')" class="btn btn-sm btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
